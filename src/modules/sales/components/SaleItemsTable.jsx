...
const SaleItemsTable = ({
  ...
  // Helper para color de vencimiento
  const getVencimientoColor = (dias) => {
    if (!dias && dias !== 0) return "text.secondary";
    if (dias <= 30) return "error.main";
    if (dias <= 90) return "warning.main";
          ...
          <TableBody>
            ...
            {items.map((item) => {
              ...
              return (
                ...
                >
                  {/* PRODUCTO — Fila 1: nombre + código/línea/lab | Fila 2: presentación + lote/vencimiento */}
                  <TableCell>
                    <Box>
                      {stockWarning && (
                      ...
                      {/* Fila 2b: lote / vencimiento / descuento por vencimiento */}
