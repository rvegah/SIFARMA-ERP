...
const InvoiceCompactPDF = React.forwardRef(({ invoiceData }, ref) => {
  const { empresa, factura, cliente, totales, pagado } = invoiceData;
  ...
  return (
    ...
    >
      ...
      <Box sx={{ textAlign: "center", mb: 1 }}>
        ...
        <Typography sx={{ fontSize: "9px" }}>NIT: {empresa.nit}</Typography>
      </Box>
      ...
      <Box sx={{ mb: 1, fontSize: "9px" }}>
        ...
        {esAlquiler && factura.periodoFacturado && (
          ...
          >
            ...
            <span>{factura.periodoFacturado}</span>
          </Box>
        )}
      ...
      <Box sx={{ display: "flex", justifyContent: "center", my: 1 }}>
        <QRCode value={factura.qrUrl} size={100} level="M" />
      </Box>
